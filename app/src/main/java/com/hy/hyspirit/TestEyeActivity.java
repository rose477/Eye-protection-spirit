...
public class TestEyeActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getLayoutId() {
        return R.layout.activity_test_eye;
    }
    ...
    private void showResult() {
        ...
        dialog.create();
        dialog.setNegativeButton("测试右眼", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {



                    startActivity(new Intent(TestEyeActivity.this, TestEyeActivity2.class));
                finish();
        ...
        dialog.setPositiveButton("获取报告", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                    ...
                    startActivity(new Intent(TestEyeActivity.this, ReportActivity.class));
